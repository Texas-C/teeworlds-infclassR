...
/* INFECTION MODIFICATION START ***************************************/
	...
	SetFireDelay(INFWEAPON_SOLDIER_SHOTGUN, GetFireDelay(INFWEAPON_SHOTGUN));
	...
	SetFireDelay(INFWEAPON_MERCENARY_RIFLE, 250);
	...
	SetAmmoRegenTime(INFWEAPON_SOLDIER_SHOTGUN, 750);
	...
	SetAmmoRegenTime(INFWEAPON_MERCENARY_RIFLE, 4000);
	...
	SetMaxAmmo(INFWEAPON_SOLDIER_SHOTGUN, 10);
	...
	SetMaxAmmo(INFWEAPON_MERCENARY_RIFLE, 10);

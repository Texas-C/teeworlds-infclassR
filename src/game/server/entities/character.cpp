...
void CCharacter::OnWeaponFired(int Weapon, bool *pFireAccepted)
{
	switch(Weapon)
	{
		case WEAPON_HAMMER:
...
void CCharacter::OnHammerFired(bool *pFireAccepted)
{
...
void CCharacter::OnGunFired(bool *pFireAccepted)
{
	vec2 Direction = GetDirection();
	vec2 ProjStartPos = GetPos()+Direction*GetProximityRadius()*0.75f;
...
void CCharacter::OnShotgunFired(bool *pFireAccepted)
{
	vec2 Direction = GetDirection();
	vec2 ProjStartPos = GetPos()+Direction*GetProximityRadius()*0.75f;
...
void CCharacter::OnGrenadeFired(bool *pFireAccepted)
{
	vec2 Direction = GetDirection();
	vec2 ProjStartPos = GetPos()+Direction*GetProximityRadius()*0.75f;
...
void CCharacter::OnLaserFired(bool *pFireAccepted)
{
	vec2 Direction = GetDirection();
...
void CCharacter::OnNinjaFired(bool *pFireAccepted)
{
